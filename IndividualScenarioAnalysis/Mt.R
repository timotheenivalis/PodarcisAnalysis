...
plot(simul$Param,simul$FixMt,col="dark blue",type="b",yaxp=c(0,1,10),ylim=c(0,1.2),pch=1,lwd=2,xlab="sélection mt",ylab="",main="Proportion de simulations avec Capture Mitochondriale, et parmi elles, \n proportion d'Introgression Nucléaire",cex.lab=1.8,cex.axis=1.5,cex.main=1.6)
